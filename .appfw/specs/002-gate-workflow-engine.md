...
> **Status : `accepted-pending-decisions`.** Implemented in `backend/src/services/` (`approval_state_machine`, `gate_eligibility`, `gate_review`, `transition`, `workspace`, `audit`). Open decisions P5 (gate matrix), Q7, A, B(Q5) block full fidelity — see `000-INDEX.md` and `../../docs/architecture/open-decisions.md`.
