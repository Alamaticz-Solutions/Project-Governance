...
from app.api.v1.endpoints import auth, users, projects, workflow, tasks, gate_reviews, dashboard, notifications, audit, meetings, meeting_index, gateway_checklist
...
api_router.include_router(gateway_checklist.router, prefix="/gateway-checklist", tags=["Gateway Checklist"])
